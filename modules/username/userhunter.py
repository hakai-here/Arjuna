...
def do_it():
    while True:
        global COUNTER,val_link_200,val_link_302
        if COUNTER <=325:
            COUNTER = COUNTER+1
        else:
            break
...
if __name__ == "__main__":
    try:
        main()
        print(f"[200] Number of places where username found : {val_link_200}")
        print(f"[302] Number of places where username found : {val_link_302}")
